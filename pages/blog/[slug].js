                ...
                <div
                  ...
                  <div className="ml-0 text-center md:ml-10 md:w-5/6 md:text-left">
                    ...
                    <div className="flex items-center justify-center pt-5 md:justify-start">
                      <a href="https://www.facebook.com/profile.php?id=100010429742389">
                        <i className="bx bxl-facebook-square text-2xl text-primary hover:text-yellow"></i>
                      </a>
                      <a href="https://mobile.twitter.com/SaptarshiNag7 " className="pl-4">
                        <i className="bx bxl-twitter text-2xl text-primary hover:text-yellow"></i>
                      </a>
                      <a href="https://www.linkedin.com/in/saptarshi-nag-132803234" className="pl-4">
                        <i className="bx bxl-linkedin text-2xl text-primary hover:text-yellow"></i>
                      </a>
                      <a href="https://instagram.com/marine_rider_12?igshid=YmMyMTA2M2Y=" className="pl-4">
          ...
          <div className="bg-primary">
            <div className="container flex flex-col justify-between py-6 sm:flex-row">
              ...
              <div className="flex items-center justify-center pt-5 pl-2 sm:justify-start sm:pt-0">
                <a href="https://www.facebook.com/profile.php?id=100010429742389" target={'_blank'}>
                  <i className="bx bxl-facebook-square text-2xl text-white hover:text-yellow"></i>
                </a>
                <a href="https://mobile.twitter.com/SaptarshiNag7 " className="pl-4" target={'_blank'}>
                  <i className="bx bxl-twitter text-2xl text-white hover:text-yellow"></i>
                </a>
                <a href="https://www.linkedin.com/in/saptarshi-nag-132803234" className="pl-4" target={'_blank'}>
                  <i className="bx bxl-linkedin text-2xl text-white hover:text-yellow"></i>
                </a>
                <a href="https://instagram.com/marine_rider_12?igshid=YmMyMTA2M2Y=" className="pl-4" target={'_blank'}>
